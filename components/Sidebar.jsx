      ...
      <div>
        ...
        >
          ...
          <div className="absolute w-max -top-12 -right-12 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none ">
            New Chat
            <div className="w-3 h-3 absolute bg-black rotate-45 left-4 -button-1.5"></div>
          </div>
        ...
        >
          ...
          <div
            className={`absolute -top-60 pb-8 ${
              !expand ? "-right-40" : ""
            } hidden group-hover:flex flex-col items-center opacity-0 group-hover:opacity-100 transition-all duration-300`}
          >
            <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg">
              <Image src={assets.qrcode} alt="QR Code" className="w-44" />
              <p className="mt-3">Check it out!</p>
              <div
                className={`w-3 h-3 absolute bg-black rotate-45 ${
