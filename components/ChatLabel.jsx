...
const ChatLabel = ({ setOpenManu, openMenu ,id , name}) => {
  ...
  return (
    ...
    >
      ...
      <div
        onClick={(e) => {
          e.stopPropagation();
          setOpenManu({ id: id, open: !openMenu.open });
        }}
      ...
      >
        ...
        >
          ...
          <div onClick={deleteHandeler} className="flex items-center gap-3 hover:bg-white/10 px-3 py-2 rounded-lg">
